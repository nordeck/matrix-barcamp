...
/**
 * Endpoints to access power levels events of rooms to evaluate user powers.
 *
...
export const powerLevelsApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    /**
     * Return the power levels events for a given room.
     */
    ...
    >({
      ...
      async onQueryStarted({ roomId, changes }, { dispatch, queryFulfilled }) {
