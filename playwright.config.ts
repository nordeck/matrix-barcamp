...
const config: PlaywrightTestConfig = {
  ...
  webServer: {
    command:
      ...
      (process.env.IMAGE_ID ?? 'matrix-barcamp-widget:latest'),
  ...
  globalSetup: require.resolve('./e2e/deploy/setup'),
  globalTeardown: require.resolve('./e2e/deploy/teardown'),
  ...
  projects: [
...

    {
      ...
      use: {
        ...
        // Firefox doesn't recognice pointer capabilities in headless mode on
